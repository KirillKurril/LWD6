...
public:
    ...
    QPushButton *pushInfo_button;
    QPushButton *delete_button;
    QPlainTextEdit *plainTextEdit;
    QPushButton *find_button;
    QPlainTextEdit *plainTextEdit_2;
    QPushButton *printTree_button;
    QMenuBar *menubar;
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        graphicsView->setGeometry(QRect(110, 10, 991, 681));
        ...
        tableWidget->setGeometry(QRect(110, 10, 281, 291));
        pushInfo_button = new QPushButton(centralwidget);
        pushInfo_button->setObjectName("pushInfo_button");
        pushInfo_button->setGeometry(QRect(10, 20, 91, 41));
        delete_button = new QPushButton(centralwidget);
        delete_button->setObjectName("delete_button");
        delete_button->setGeometry(QRect(410, 30, 91, 31));
        plainTextEdit = new QPlainTextEdit(centralwidget);
        plainTextEdit->setObjectName("plainTextEdit");
        plainTextEdit->setGeometry(QRect(530, 30, 104, 31));
        find_button = new QPushButton(centralwidget);
        find_button->setObjectName("find_button");
        find_button->setGeometry(QRect(410, 80, 91, 31));
        plainTextEdit_2 = new QPlainTextEdit(centralwidget);
        plainTextEdit_2->setObjectName("plainTextEdit_2");
        plainTextEdit_2->setGeometry(QRect(530, 80, 104, 31));
        printTree_button = new QPushButton(centralwidget);
        printTree_button->setObjectName("printTree_button");
        printTree_button->setGeometry(QRect(10, 70, 91, 41));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        pushInfo_button->setText(QCoreApplication::translate("MainWindow", "PushInfo", nullptr));
        ...
        printTree_button->setText(QCoreApplication::translate("MainWindow", "Print Tree", nullptr));
    } // retranslateUi
